...
public class EMFCustomBlazeEntityModel<T extends LivingEntity> extends BlazeEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomBlazeEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                BlazeEntityModel.getTexturedModelData().createModel(),
                model, optifineMap));
