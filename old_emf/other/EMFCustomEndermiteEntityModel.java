...
public class EMFCustomEndermiteEntityModel<T extends LivingEntity> extends EndermiteEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomEndermiteEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                EndermiteEntityModel.getTexturedModelData().createModel(),
                model, optifineMap));
