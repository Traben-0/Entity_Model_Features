...
public class EMFCustomSquidEntityModel<T extends LivingEntity> extends SquidEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomSquidEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                SquidEntityModel.getTexturedModelData().createModel(),
                model, optifineMap));
