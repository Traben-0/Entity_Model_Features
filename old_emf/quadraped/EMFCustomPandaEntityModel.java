...
public class EMFCustomPandaEntityModel<T extends LivingEntity,A extends PandaEntity> extends PandaEntityModel<A> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomPandaEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                PandaEntityModel.getTexturedModelData().createModel(),
                model, optifineMap));
