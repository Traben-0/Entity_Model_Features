...
- partially fixed compatibility with Essential cosmetics and animated player models *(currently doesn't work when the root part animates, the fix has been supplied to the Essential team)*
