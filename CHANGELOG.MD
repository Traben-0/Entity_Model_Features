...
[?]
- fixed several model exporting issues, including missing parts, wrong rotations, and rabbit/axolotl legs on 26.1+
- fixed vex items not matching animated arm positions
- improved item attachment handling
