...
public class EMFConfigScreenDebugLogOptions extends ETFConfigScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(getETFButton((int) (this.width * 0.2), (int) (this.height * 0.4), (int) (this.width * 0.6), 20,
                Text.of(new TranslatableText("entity_model_features.config.debug_right_click").getString() +
                ...
                (button) -> {
                    ...
                    button.setMessage(Text.of(new TranslatableText("entity_model_features.config.debug_right_click").getString() +
                            ": " + (emfParent.tempConfig.debugOnRightClick ? ScreenTexts.ON : ScreenTexts.OFF).getString()));
                },
                new TranslatableText("entity_model_features.config.debug_right_click.tooltip")
        ));
