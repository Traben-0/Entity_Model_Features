...
public abstract class MathValue implements MathComponent {
    ...
    /**
     * This is simply a {@link java.util.function.Supplier<Float>}
     * It is declared separately for the sake of code clarity and to avoid confusion with {@link java.util.function.Supplier<Float>} & {@link MathComponent}
     * <p>
