...
public final class VariableRegistry {
    ...
    private VariableRegistry() {
        ...
        registerSimpleBoolVariable("is_crawling", () -> {
            if (EMFAnimationEntityContext.getEMFEntity() == null) return false;
            return EMFAnimationEntityContext.getEMFEntity() instanceof Entity entity && entity.isInSwimmingPose() && entity.isOnGround();//1.28.2 maybe works? not a major issues if not
        });
