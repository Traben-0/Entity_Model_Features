...
public class EMFCustomPigEntityModel<T extends LivingEntity> extends PigEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomPigEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                PigEntityModel.getTexturedModelData(new Dilation(0)).createModel(),
                model, optifineMap));
