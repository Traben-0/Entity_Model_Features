...
public class EMFCustomCreeperEntityModel<T extends LivingEntity> extends CreeperEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomCreeperEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                CreeperEntityModel.getTexturedModelData(new Dilation(0)).createModel(),
                model, optifineMap));
