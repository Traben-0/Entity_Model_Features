...
public class EMFCustomDolphinEntityModel<T extends LivingEntity> extends DolphinEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomDolphinEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                DolphinEntityModel.getTexturedModelData().createModel(),
                model));
