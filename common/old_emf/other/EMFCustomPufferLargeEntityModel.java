...
public class EMFCustomPufferLargeEntityModel<T extends LivingEntity> extends LargePufferfishEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomPufferLargeEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                LargePufferfishEntityModel.getTexturedModelData().createModel(),
                model, optifineMap));
