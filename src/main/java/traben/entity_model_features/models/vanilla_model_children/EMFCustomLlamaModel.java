...
import traben.entity_model_features.mixin.accessor.entity.LlamaEntityModelAccessor;
...
public class EMFCustomLlamaModel<T extends LivingEntity, M extends AbstractDonkeyEntity> extends LlamaEntityModel<M> implements EMFCustomModel<T> {
