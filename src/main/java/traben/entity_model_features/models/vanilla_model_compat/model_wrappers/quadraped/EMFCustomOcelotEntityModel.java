...
public class EMFCustomOcelotEntityModel<T extends LivingEntity> extends OcelotEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomOcelotEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                OcelotEntityModel.getModelData(new Dilation(0)).getRoot().createPart(0,0),
                model, optifineMap));
