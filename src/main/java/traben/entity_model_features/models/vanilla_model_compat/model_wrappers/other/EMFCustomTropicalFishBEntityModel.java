...
public class EMFCustomTropicalFishBEntityModel<T extends LivingEntity> extends LargeTropicalFishEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomTropicalFishBEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                LargeTropicalFishEntityModel.getTexturedModelData(new Dilation(0)).createModel(),
                model));
