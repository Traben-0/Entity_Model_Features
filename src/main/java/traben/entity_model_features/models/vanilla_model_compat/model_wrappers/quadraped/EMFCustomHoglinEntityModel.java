...
public class EMFCustomHoglinEntityModel<T extends LivingEntity,A extends MobEntity & Hoglin> extends HoglinEntityModel<A> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomHoglinEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                HoglinEntityModel.getTexturedModelData().createModel(),
                model, optifineMap));
