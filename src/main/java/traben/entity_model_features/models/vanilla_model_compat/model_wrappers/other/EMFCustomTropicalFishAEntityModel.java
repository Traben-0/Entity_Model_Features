...
public class EMFCustomTropicalFishAEntityModel<T extends LivingEntity> extends SmallTropicalFishEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomTropicalFishAEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                SmallTropicalFishEntityModel.getTexturedModelData(new Dilation(0)).createModel(),
                model));
