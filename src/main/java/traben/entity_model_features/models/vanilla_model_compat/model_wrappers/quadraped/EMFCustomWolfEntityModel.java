...
public class EMFCustomWolfEntityModel<T extends LivingEntity,A extends WolfEntity> extends WolfEntityModel<A> implements EMFCustomEntityModel<T> {
    ...
    private static final HashMap<String,String> optifineMap = new HashMap<>(){{
        ...
        put("upper_body", "mane");
        //todo possible real_head and real_tail needs inclusion
    }};
    public EMFCustomWolfEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                WolfEntityModel.getTexturedModelData().createModel(),
                model, optifineMap));
