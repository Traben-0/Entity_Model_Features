...
public class EMFCustomChickenEntityModel<T extends LivingEntity> extends ChickenEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomChickenEntityModel(EMFGenericCustomEntityModel<T> model) {
