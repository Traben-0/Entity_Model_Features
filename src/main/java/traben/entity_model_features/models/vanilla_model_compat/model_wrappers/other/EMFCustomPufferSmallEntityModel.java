...
public class EMFCustomPufferSmallEntityModel<T extends LivingEntity> extends SmallPufferfishEntityModel<T> implements EMFCustomEntityModel<T> {
    ...
    private static final HashMap<String,String> optifineMap = new HashMap<>(){{
        put("left_fin","fin_left");
        put("right_fin","fin_right");
    }};
    public EMFCustomPufferSmallEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                SmallPufferfishEntityModel.getTexturedModelData().createModel(),
                model, optifineMap));
