...
public class EMFCustomAxolotlEntityModel<T extends LivingEntity, A extends AxolotlEntity & AngledModelEntity> extends AxolotlEntityModel<A> implements EMFCustomEntityModel<T> {
    ...
    public EMFCustomAxolotlEntityModel(EMFGenericCustomEntityModel<T> model) {
        ...
        super( EMFCustomEntityModel.getFinalModelRootData(
                AxolotlEntityModel.getTexturedModelData().createModel(),
                model, optifineMap));
